...
<div class="container-fluid">
	<h1 class='text-light'>Please Enter A New End Date</h1>
	<div class = "container center_div">
		<% if (exception != null){%>
		<div class="alert alert-danger" role="alert"><strong>Error!</strong> <%=exception%></div>
		<%}%>
		<form action="http://localhost:8080/TodoList_project/Controller/items/changeTime" method="post">
	      ...
	      <div class="form-group col-sm-12"> <!-- Date input -->
	        <input class="form-control" id="timepicker" name="time" placeholder="HH:MM" value="12:00" type="text"/>
	      </div>
